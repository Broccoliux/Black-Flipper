...
Designed to outperform Flipper Zero in many hardware aspects, including range, protocol support, processing power, display size, touchcreen capability, GPS, LoRa, and WIFI.
